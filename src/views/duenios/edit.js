...
export const EditDuenioModal = ({ open, rowData, onClose, onSubmit }) => {
    ...
    const [listaTelefonos, setListaTelefonos] = React.useState(rowData.contactos.filter(function (element){
        return element.tipoDeContacto === 1;
    }));
    const [listaCorreos, setListaCorreos] = React.useState(rowData.contactos.filter(function (element){
        return element.tipoDeContacto === 2;
    }));
    ...
    // apoderados
    const [listaApoderados, setListaApoderados] = React.useState(rowData.apoderados);
    ...
    // cuentas bancarias
    const [listaCuentasBancarias, setListaCuentasBancarias] = React.useState(rowData.cuentasBancarias);
    ...
    return(
        <Dialog
            ...
            <form onSubmit={formik.handleSubmit}>
                <DialogTitle textAlign="center" variant="h2">Editar Dueño ID #{formik.values.id}</DialogTitle>
                <DialogContent>
                        ...
                        <Grid item xs={12} md={6}>
                            <FormControl fullWidth margin="dense">
                                ...
                                <Select
                                    ...
                                    name="regimenFiscal"
                                    value={formik.values.regimenFiscal === null?'0':formik.values.regimenFiscal}
                                    label="Age"
                                    onChange={formik.handleChange}
                                >
